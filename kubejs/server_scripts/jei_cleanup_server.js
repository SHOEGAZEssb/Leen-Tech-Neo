...
ServerEvents.recipes(event => {
  ...
  // biomes o plenty
  removeRecipesByItemIdWildcard(event, "biomesoplenty:*maple*", ["biomesoplenty:yellow_maple_leaf_pile", "biomesoplenty:yellow_maple_leaves", "biomesoplenty:yellow_maple_sapling", "biomesoplenty:orange_maple_leaf_pile", "biomesoplenty:orange_maple_leaves", "biomesoplenty:orange_maple_sapling", "biomesoplenty:red_maple_leaf_pile", "biomesoplenty:red_maple_leaves", "biomesoplenty:red_maple_sapling"])
